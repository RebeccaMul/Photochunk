...
<div class="row">
   ...
   <h2 style="margin-left:5%;">Welcome <asp:Label ID="username" runat="server" Text="" Style="margin"></asp:Label>!</h2><br />
            ...
            <div id="help" style="background-color:darkgray; color:white; margin-left:5%; margin-right:10%; padding:10px;">
                ...
                <p> Here a few tips on using <b>PhotoChunk</b> as an Admin.<br /><br />
...
<u>Admin Functionality:</u><br /><br />
                <b><a href="Adminaccounts.aspx">Manage Users</a></b>- Here you will be able to edit User account details.<br /> Change a user's access level - e.g. Make them a creator, or demote them to registered. You can also delete any user's account or reset the account's password. <br />
                <br /><b><a href="Browse.aspx">Moderate Comments and Likes</a></b>- Here you can edit or delete comments.
