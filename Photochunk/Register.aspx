...
<div class="row">
	<div class="small-12 medium-12 large-12 columns">
        ...
        <div id="form" style="margin-left:33%; margin-right:33%;">
            <h3 style="margin-left:40%; margin-right:33%;">Register:</h3><br />

        <p>Username:<asp:TextBox ID="reguser" runat="server" ToolTip="Your desired account username" required></asp:TextBox></p>
           

            <p>Forename:<asp:TextBox ID="Fname" runat="server" ToolTip="Your first name" required></asp:TextBox></p>

            <p>Surname:<asp:TextBox ID="Sname" runat="server" ToolTip="Your second name" required></asp:TextBox></p>

            
            <p>Email:<asp:TextBox ID="regemail" runat="server" ToolTip="Your email address" TextMode="Email" required></asp:TextBox></p>

        <p>Password:<asp:TextBox ID="regpass" runat="server" ToolTip="Your account password" required></asp:TextBox></p>
            
        <asp:Button ID="regbtn" runat="server" Text="Create Account" style="margin-left:40%; margin-right:33%;" OnClick="regbtn_Click"  />

            <br /><br /><asp:Label ID="failed" runat="server" Text="" Style="color:darkred;"></asp:Label>
            
        <p><br />Already have an account? <br /> <a href="Login.aspx">Login here</a></p></div>
