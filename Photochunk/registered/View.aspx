...
<EditItemTemplate>
        ...
        <br /><asp:Button ID="Like" runat="server" Text="    ♡    " OnClick="Like_Click" Style="float:right; font-size:x-large; font-weight:700;" />
             ...
             <div class="AddComment">
                 ...
                 <asp:Button ID="Post" runat="server" Text="Post Comment"  OnClick="Post_Click" /></div><br /></asp:Panel><br />
            </div>

        <asp:SqlDataSource ID="CommentData" runat="server" ConnectionString='<%$ ConnectionStrings:photocatconnection %>' SelectCommand="SELECT Photos.PhotoId, Comments.CmtId, Comments.CmtText, Comments.PhotoId, Comments.UserId, Comments.Date, Users.UserID, Users.Username
FROM
Comments 
INNER JOIN
Photos ON
