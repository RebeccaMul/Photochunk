<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateimg.aspx.cs" Inherits="about" %>
	...
	<div class="small-12 medium-12 large-12 small-centered columns">
		<nav>
			<ul class="inline-list-custom">
                ...
                <li><a href="UpdateImg.aspx" class="current" >Edit</a></li>
...
<div class="row">
    ...
    <asp:SqlDataSource ID="photoedit" runat="server" ConnectionString='<%$ ConnectionStrings:photocatconnection %>' SelectCommand="SELECT Photos.PhotoID, Photos.ImagePath, Photos.Location, Photos.Description, Photos.Date, Photos.Likes, Users.Username, Category.Category, Category.CatID FROM
Photos INNER JOIN
...
WHERE Photos.UserId = @UserId">
        <SelectParameters>
            <asp:SessionParameter SessionField="id" Name="UserId"></asp:SessionParameter>
        </SelectParameters>
    </asp:SqlDataSource>

        <asp:ListView ID="ListView1" runat="server" DataSourceID="photoedit" DataKeyNames="PhotoID" GroupItemCount="3">
            <EmptyDataTemplate>
            ...
            <ItemTemplate>
                <td runat="server" style="">                    
                    <asp:Image ID="listimage" runat="server" ImageUrl='<%# "../"+Eval("ImagePath") %>' Width="400px" Height="300px"  /><br /><br />
                     <div class="editbutton">
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "edit.aspx?photoID=" + Eval("PhotoID") + "&ImagePath=" + Eval("ImagePath") + "&CatID=" + Eval("CatID") %>'>Edit</asp:HyperLink></div>
                  ...
                  Uploaded by:
                    ...
                    Category:
                    <asp:Label Text='<%# Eval("Category") %>' runat="server" ID="CategoryLabel" /><br /><br />
                </td>
            </ItemTemplate>
            <LayoutTemplate>
                <table runat="server">
